        ...
        {home && <nav className="ml-auto flex items-center gap-10">
            <div className="flex gap-5">
                <div onClick={scrollToTop} className="flex flex-col items-center cursor-pointer">
                    ...
                    <span className="block p-2 md:shadow-sm md:hover:shadow-md transition-all text-xs md:text-xl">{less768px ? "Стиль" : 'Знайди свій стиль!'}</span>
                </div>
                <RSLink to='snickersContainer' smooth={true} duration={1700}>
                    <div className="flex flex-col items-center cursor-pointer">
                        ...
                        <span className="block p-2 md:shadow-sm md:hover:shadow-md transition-all text-xs md:text-xl">{less768px ? "Товари" : "Найпопулярніші товари"}</span>
                    </div>
                </RSLink>
            </div>
        </nav>}
