...
export default function Hero() {
    ...
    return (
        ...
        <Element name="hero">
            ...
            <p className="pl-1 indent-2.5 md:text-xl">Сьогодні одяг для спорту високої якості купити не так просто.
            ...
            <p className="pl-1 indent-2.5 md:text-xl">Доставка по всій території України. Не важливо в якому населеному пункті Ви живете:
                Сєвєродонецьк, Павлоград, Бровари, Бердянськ, Нікополь, Слов_янськ, Мелітополь, Краматорськ, Біла Церква, Кременчук,
                Кам_янське, Кам_янець-Подільський, Лисичанськ, Олександрія, Костянтинівка, Алчевськ, Конотоп, Умань, Бердичів,
                Бердичів, Шостка, Ізмаїл, - наш інтернет магазин доставить покупку зручним способом: кур_єр, новою поштою, самовивіз.</p>
        </section>)
 };